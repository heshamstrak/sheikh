    ...
    <div class="col-lg-12 col-ml-12 padding-bottom-30">
        <div class="row">
            ...
            <div class="col-lg-12 mt-t">
                <div class="card">
                    <div class="card-body">
                        <h4 class="header-title"><?php echo e(__('Popular News Area Settings')); ?></h4>

                        <form action="<?php echo e(route('admin.home20.popular')); ?>" method="post" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <nav>
                                ...
                                <?php $__currentLoopData = $all_languages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $lang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="tab-pane fade <?php if($key == 0): ?> show active <?php endif; ?>" data-slug="<?php echo e($lang->slug); ?>" id="nav-home-<?php echo e($lang->slug); ?>" role="tabpanel" aria-labelledby="nav-home-tab">
                                        <div class="form-group">
                                            <label for="home20_popular_news_section_<?php echo e($lang); ?>_section_title"><?php echo e(__('Section Title')); ?></label>
                                            <input type="text" name="home20_popular_news_section_<?php echo e($lang->slug); ?>_section_title" value="<?php echo e(get_static_option('home20_popular_news_section_'.$lang->slug.'_section_title')); ?>" class="form-control" >
                                        </div>
                                        <div class="form-group">
                                            <label ><?php echo e(__('Categories')); ?></label>
                                            <select class="form-control nice-select wide categories_select" name="home20_popular_news_section_<?php echo e($lang->slug); ?>_categories[]" multiple>
                            ...
                            <div class="form-group">
                                <label for="home20_popular_news_section_items"><?php echo e(__('News Items')); ?></label>
                                <input type="number" name="home20_popular_news_section_items" value="<?php echo e(get_static_option('home20_popular_news_section_items')); ?>" class="form-control" >
                            </div>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Volumes/DATA/Projects/Laravel/Work/shaki/resources/views/backend/pages/home/newspaper/popular-news.blade.php ENDPATH**/ ?>